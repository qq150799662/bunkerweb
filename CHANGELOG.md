...
- [BUGFIX] Enhance ConfigurableCustomUndefined with safe attribute retrieval and improved config handling to prevent errors during template rendering with python 3.14
